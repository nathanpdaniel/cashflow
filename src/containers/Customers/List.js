  ...
  render() {
    ...
    <Grid container={true} spacing={24} style={{ width: 800, margin: '0 auto' }}>
      ...
      <Grid item xs={6} style={{ textAlign: 'right' }}>
        <Button onClick={() => browserHistory.push('/customer')}>+ Add Customer</Button>
        <Button onClick={() => browserHistory.push('/customer/pay')}>Take Payment</Button>
      </Grid>
      <Grid item xs={12}>
        <Paper style={{ padding: 24 }}>
          <Table>
            ...
            <TableBody>
              <TableRow>
                <TableCell>Garden Alley</TableCell>
                <TableCell>123 A St, Atlanta, GA  30363</TableCell>
                <TableCell><Checkbox checked={true} /></TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Botanical Gardens</TableCell>
                <TableCell>Piedmont Ave, Atlanta, GA  30308</TableCell>
                <TableCell><Checkbox checked={true} /></TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Get Plants</TableCell>
